...
![alt text](./Images/VD8.png)

## Approach 

First the code was messy so I cleaned it with proper indentation
...
This is my code to reverse engineer this process : [VaultDoor8](./Resources&SourceCodes/VaultDoor8.java)
